<style lang="postcss">
  .tile {
    @apply text-red-100 text-center uppercase tracking-wide font-semibold
      text-4xl px-4 py-3 shadow rounded-full;
  }
  .tile:hover {
    @apply shadow-xl;
  }
